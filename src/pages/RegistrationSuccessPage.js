    ...
    <Container fluid>
      <Stack gap={3} className="position-relative vh-100 text-center">
        <div className="position-absolute top-50 start-50 translate-middle col-sm-10">
          <div className="h1 cinzel py-3">Thank you for Registering</div>
          <div>
            <p>
              A verification email will be sent to you shortly from Session
              Staff Admin. If none appears in your inbox please check your email
